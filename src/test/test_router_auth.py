...
from src.utility.auth import CredentialException
from src.main import app
from src.routers.auth import get_current_active_user
from src.utility.database_wrappers import get_user_by_email_db
...
def override_logged_in_user():
    return get_user_by_email_db("testing@email.com")
...
@pytest.mark.timeout(5)
def test_login():
    testing_account_password = get_user_by_email_db('testing@email.com').agency  # We store the pass in the agency ONLY for testing
